...
1.Cree de máquina virtual Windows Server 2019 edición estándar con GUI (8gb RAM, 30GB disco y 2 vcpu), utilizando ISO dispuesta en el laboratorio.  

Verifique la dirección IP  
Habilite la opción de acceso remoto por RDP.

2.Cree de Máquina virtual Linux RHEL9 o similar (Rocky, Alma, otro) solo CLI (8gb RAM, 30GB disco y 2 vcpu) utilizando ISO dispuesta en el laboratorio.  
